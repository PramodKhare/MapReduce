 ...
 * 
 * @FileName MedianPurchaseV4.java (Map Reduce (either form V2 or V3) where each call to map also
 *           computes Fibbonacci of N.) (Here uses V2)
 * @author Pramod Khare
 * @Created Wed 21 Jan 2015 09:00:00 AM EST
 * @Modified Fri 30 Jan 2015 11:00:00 PM EST
 */
...
public class MedianPurchaseV4 {
    public static void main(String[] args) throws Exception {
        ...
        job.setJobName("Median purchase by category V4 using MapReduce basic version");
