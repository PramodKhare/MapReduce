 ...
 *           example.
 * @FileName MedianPurchaseReducerV2.java
 * @author Pramod Khare
...
public class MedianPurchaseReducerV2 extends Reducer<Text, IntWritable, Text, IntWritable> {
    ...
    public void reduce(Text key, Iterable<IntWritable> values, Context context) throws IOException,
        ...
        // calculate the Median value and emit it to output
